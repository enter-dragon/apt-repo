...
curl --silent -LO https://github.com/enter-dragon/mainline-kernel/releases/latest/download/bzImage
curl --silent -LO https://github.com/enter-dragon/mainline-kernel/releases/latest/download/headers.tar.xz
